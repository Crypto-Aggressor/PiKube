...
gpu_memory_split = os.getenv('MEMORY_GPU_SPLIT')
...
# Change GPU Memory Split to 16 MB and log the initial and final configurations
cluster_manager.change_gpu_memory_split(gpu_memory_split)
